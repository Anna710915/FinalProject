                        ...
                        <c:otherwise>
                            ...
                            <table class="table table-striped text-center">
                                ...
                                <tr>
                                    ...
                                    <th><fmt:message key="menu.product_composition"/> </th>
                                ...
                                <c:forEach var="menu" items="${menu_list}">
                                    <input type="hidden" value="<c:out value="${menu.foodId}"/>"/>
                                    <tr>
                                        <td><c:out value="${menu.nameFood}"/></td>
                                        <td><c:out value="${menu.composition}"/></td>
